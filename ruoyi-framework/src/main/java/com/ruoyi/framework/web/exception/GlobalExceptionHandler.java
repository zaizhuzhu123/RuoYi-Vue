...
public class GlobalExceptionHandler
{
    ...
    public ResponseResult handleAccessDeniedException(AccessDeniedException e, HttpServletRequest request)
    {
        ...
        return ResponseResult.fail(HttpStatus.FORBIDDEN, "没有权限，请联系管理员授权");
    }
    ...
    public ResponseResult handleServiceException(ServiceException e, HttpServletRequest request)
    {
        ...
        return StringUtils.isNotNull(code) ? ResponseResult.fail(code, e.getMessage()) : ResponseResult.fail(e.getMessage());
    }
    ...
    {
        return ResponseResult.fail("演示模式，不允许操作");
    }
}
